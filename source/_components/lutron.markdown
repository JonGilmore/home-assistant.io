...
This integration uses keypad programming to identify scenes.  Currently, it works with SeeTouch, main repeater, homeowner, tabletop, and hybrid SeeTouch keypads.
